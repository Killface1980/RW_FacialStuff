namespace FacialStuff
{
    ...
    public static class HumanMouthGraphics
    {
        public static readonly MouthGraphicData[] HumanMouthGraphic =
            {
                new MouthGraphicData(0f, FacialGraphics.MouthGraphic06),
                new MouthGraphicData(0.25f, FacialGraphics.MouthGraphic05),
                new MouthGraphicData(0.4f, FacialGraphics.MouthGraphic04),
                new MouthGraphicData(0.55f, FacialGraphics.MouthGraphic03),
                new MouthGraphicData(0.7f, FacialGraphics.MouthGraphic02),
                new MouthGraphicData(0.85f, FacialGraphics.MouthGraphic01)
            };
