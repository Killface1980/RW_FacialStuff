...
namespace FacialStuff.Detouring
{
    ...
    public static class _PawnHairColors
    {
        ...
        public static Color RandomHairColor(Color skinColor, int ageYears)
        {
            ...
            {
                tempColor = Color.Lerp(HairColors["HairMidnightBlack"], HairColors["HairDarkBrown"], Rand.Range(0f, 0.35f));
            ...
            else
            {
                ...
                {
                    tempColor = Color.Lerp(HairColors["HairPlatinum"], HairColors["HairTerraCotta"], Rand.Range(0.25f, 1f));
                    tempColor = Color.Lerp(tempColor, HairColors["HairMidnightBlack"], Rand.Range(0f, 0.35f));
                }
                // pure blond / albino
                else if (value2 < 0.85f)
                {
                    tempColor = Color.Lerp(HairColors["HairPlatinum"], HairColors["HairYellowBlonde"], Rand.Range(0f, 0.5f));
                }

                // red hair
                else
                {
                    tempColor = Color.Lerp(HairColors["HairYellowBlonde"], HairColors["HairTerraCotta"], Rand.Range(0.25f, 1f));
