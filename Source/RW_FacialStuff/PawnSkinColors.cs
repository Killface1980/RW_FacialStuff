...
namespace RW_FacialStuff
{
    public static class PawnSkinColorsModded
    {
        ...
        {
            new SkinColorData(0f, 0.05f, new Color32(74,41,25, 255)),
            new SkinColorData(0.1f, 0.1f, new Color32(122,54,25,255)),
            new SkinColorData(0.2f, 0.15f, new Color32(165,93,41,255)),
            new SkinColorData(0.3f, 0.2f, new Color32(186,119,80,255)),
            new SkinColorData(0.4f, 0.25f, new Color32(230,158,124,255)),
            new SkinColorData(0.5f, 0.3f, new Color32(231,184,143,255)),
            new SkinColorData(0.66f, 0.8f, new Color32(237,194,154,255)),
            new SkinColorData(0.83f, 0.9f, new Color32(245,210,178,255)),
