...
namespace FacialStuff.GraphicsFS
{
    ...
    public static class MeshPoolFS
    {
        ...
        public static Vector2 EyeFemaleAverageNormalOffset = new(-0.01006f, 0f);
        public static Vector2 EyeFemaleAveragePointyOffset = new(-0.01258f, 0f);
        public static Vector2 EyeFemaleAverageWideOffset   = new(-0.01835f, 0f);
        public static Vector2 EyeFemaleNarrowNormalOffset  = new(-0.02264f, 0f);
        public static Vector2 EyeFemaleNarrowPointyOffset  = new(-0.01256f, 0f);
        public static Vector2 EyeFemaleNarrowWideOffset    = new(-0.01509f, 0f);
        public static Vector2 EyeMaleAverageNormalOffset   = new(0f,        0f);
        public static Vector2 EyeMaleAveragePointyOffset   = new(-0.01256f, 0f);
        public static Vector2 EyeMaleAverageWideOffset     = new(0f,        0f);
        public static Vector2 EyeMaleNarrowNormalOffset    = new(-0.02516f, 0f);
        public static Vector2 EyeMaleNarrowPointyOffset    = new(-0.02516f, 0f);
        public static Vector2 EyeMaleNarrowWideOffset      = new(-0.02516f, 0f);

        public static Vector2 MouthFemaleAverageNormalOffset = new(0.14331f, 0.13585f);
        public static Vector2 MouthFemaleAveragePointyOffset = new(0.16100f, 0.13836f);
        public static Vector2 MouthFemaleAverageWideOffset   = new(0.16604f, 0.13962f);
        public static Vector2 MouthFemaleNarrowNormalOffset  = new(0.12956f, 0.15346f);
        public static Vector2 MouthFemaleNarrowPointyOffset  = new(0.12328f, 0.16604f);
        public static Vector2 MouthFemaleNarrowWideOffset    = new(0.12075f, 0.16101f);
        public static Vector2 MouthMaleAverageNormalOffset   = new(0.18491f, 0.15724f);
        public static Vector2 MouthMaleAveragePointyOffset   = new(0.19874f, 0.15346f);
        public static Vector2 MouthMaleAverageWideOffset     = new(0.21636f, 0.14843f);
        public static Vector2 MouthMaleNarrowNormalOffset    = new(0.12810f, 0.17610f);
        public static Vector2 MouthMaleNarrowPointyOffset    = new(0.11824f, 0.17358f);
        public static Vector2 MouthMaleNarrowWideOffset      = new(0.11825f, 0.17623f);
