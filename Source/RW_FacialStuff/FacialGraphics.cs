    ...
    public static class FacialGraphics
    {
        ...
        public static Texture2D MaskTex_Narrow_FrontBack
        {
            get
            {
                ...
                {
                    maskTexNarrowFrontBack = FacialGraphics.MakeReadable(ContentFinder<Texture2D>.Get("MaskTex/MaskTex_Narrow_front+back"));
                }
        ...
        public static Texture2D MaskTex_Narrow_Side
        {
            get
            {
                ...
                {
                    maskTexNarrowSide = FacialGraphics.MakeReadable(ContentFinder<Texture2D>.Get("MaskTex/MaskTex_Narrow_side"));
                }
        ...
        public static Texture2D MaskTex_Average_FrontBack
        {
            get
            {
                ...
                {
                    maskTexAverageFrontBack = FacialGraphics.MakeReadable(ContentFinder<Texture2D>.Get("MaskTex/MaskTex_Average_front+back"));
                }
        ...
        public static Texture2D MaskTex_Average_Side
        {
            get
            {
                ...
                {
                    maskTexAverageSide = FacialGraphics.MakeReadable(ContentFinder<Texture2D>.Get("MaskTex/MaskTex_Average_side"));
                }
