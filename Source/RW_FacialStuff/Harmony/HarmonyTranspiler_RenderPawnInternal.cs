namespace FacialStuff.Harmony
{
    ...
    public static class HarmonyPatch_RenderPawnInternal
    {
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator il)
        {
            ...
            {
                CodeInstruction codeInstruction = instList[i];
                ...
                if (codeInstruction.opcode == OpCodes.Ldarg_3 && bodyPatchState == 0)
                {
                ...
                */
                ...
                if (codeInstruction.opcode == OpCodes.Stloc_S && codeInstruction.operand is LocalBuilder lb1 && lb1.LocalIndex == 11 && headPatchState == 0)
                {
                ...
                ...
                */
                if (codeInstruction.opcode == OpCodes.Ldloc_S && codeInstruction.operand is LocalBuilder lb2 && lb2.LocalIndex == 14 && hairPatchState == 0)
                {
                ...
                */
                ...
                if (codeInstruction.opcode == OpCodes.Call && ((MethodInfo)codeInstruction.operand).Name.Equals("DrawEquipment") && handPatchState == 0)
                {
            ...
            bool portrait)
        {
            ...
            if (compFace != null && !portrait)
            {
                ...
                headFacing =  compFace..he.GetHeadFacing();
            }
        }
            ...
            Quaternion bodyQuat)
        {
            ...
            if (compFace != null)
            {
                ...
                compFace.DrawBasicHead(out bool headDrawn, bodyDrawType, portrait, headStump, headDrawLoc, bodyQuat);
                return headDrawn;
            }
            return false;
        }
